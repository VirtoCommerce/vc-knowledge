...
sources:
  ...
  - knowledge/oracles/business-logic.md Domain 20 (BL-SR-001..032, read for orientation, cited not restated)
  - knowledge/domain/b2b-organizations.md rev 1 (the adjacent map; its Sales-Rep pointer rows resolved here)
...
**Not the default `/graphql` endpoint** — `knowledge/api/graphql-schema.md` documents only the
