...
evidence:
  ...
  - method: observation
    ...
    at: 2026-09-23T08:14:04.676Z
    by: session:70b7199f
    who: Dan-BV
    note: Holds on virtostart too, not just vcst-qa. Simple-product PDPs (SKU ALCE0128, and the digital "The Kitchen in the Basement" product) add via the quantity stepper with no Add-to-cart button, while the configurable PDPs "Vintage Wedding cake" and "Off-Road Bike. Configurable product" both render a real "Add to cart" button in the price block.
---
