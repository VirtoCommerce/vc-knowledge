...
evidence:
  ...
  - method: observation
    deployment: vcst-qa
    at: 2026-09-25T11:17:23.044Z
    by: session:memimpor
    who: Lenajava1
    note: "Also on vcst-qa: DELETE on the configurations route returns 405, GET by productId query parameter returns 404, and deactivating with PATCH isActive=false is the teardown path."
---
