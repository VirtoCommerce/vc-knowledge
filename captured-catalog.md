...
Written by agents through `kb capture`, not generated. 47 active entries, 4 retired.
...
| [`KB-358A70CB`](captured/KB-358A70CB.md) | `storefront order page projection of the shipment` | 1 | no | surface=storefront-ui |
| [`KB-35A09C64`](captured/KB-35A09C64.md) | `promotion re-evaluation on cart read` | 1 | no | surface=storefront-xapi |
...
| [`KB-4982C91F`](captured/KB-4982C91F.md) | `order-discount-amount-rounding-split` | 1 | no | surface=rest surface=admin-ui reward=percentage-off-cart-subtotal |
...
| [`KB-4CCC2DD6`](captured/KB-4CCC2DD6.md) | `what Cancel document on an order actually cancels` | 2 | no | surface=admin-ui |
...
| [`KB-6E98AA17`](captured/KB-6E98AA17.md) | `admin order operations tree staleness after cancel` | 1 | no | surface=admin-ui |
...
| [`KB-996BDF08`](captured/KB-996BDF08.md) | `cart-level promotion reward placement` | 2 | no | surface=storefront-xapi |
...
| [`KB-CA4C93E4`](captured/KB-CA4C93E4.md) | `discount-rate-not-persisted-on-order` | 1 | no | surface=storefront-xapi surface=rest principal=customer |
...
| [`KB-D4A064A5`](captured/KB-D4A064A5.md) | `promotion discount rounding on the cart` | 2 | no | surface=storefront-xapi |
...
| [`KB-FF7E4D5B`](captured/KB-FF7E4D5B.md) | `cart-subtotal-percentage-reward-on-customerorder` | 1 | no | surface=storefront-xapi surface=rest principal=customer reward=percentage-off-cart-subtotal |
