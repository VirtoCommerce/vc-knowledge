...
Written by agents through `kb capture`, not generated. 39 active entries, 3 retired.
...
| [`KB-0DD47BD1`](captured/KB-0DD47BD1.md) | `the amount a payment is for is not the payment's total` | 1 | no | surface=rest surface=admin-ui |
...
| [`KB-4CCC2DD6`](captured/KB-4CCC2DD6.md) | `what Cancel document on an order actually cancels` | 1 | no | surface=admin-ui |
